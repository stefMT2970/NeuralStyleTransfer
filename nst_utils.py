...
class CONFIG:
    ...
    STYLE_IMAGE = 'images/Claude-Monet-The-Houses-of-Parliament-Sunset-detail.jpg' # Style image to use.
    CONTENT_IMAGE = 'images/desk.jpg' # Content image to use.
    OUTPUT_DIR = 'output/'
    WORKING_DIR = "d:/dev/gitrepo/NeuralStyleTransfer/"
    STYLE_LAYERS = [
            ('conv1_1', 0.2),
            ('conv2_1', 0.2),
            ('conv3_1', 0.2),
